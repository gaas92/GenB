...
step0_fragmentfile="BdToKs0JpsiMuMu_BPH-Commission22GS-NoFilter.py" 
step0_configfile="step0-GS-${CHANNEL_DECAY}-NoFilter-run_cfg.py"
step0_resultfile="step0-GS-${CHANNEL_DECAY}-NoFilter-result.root"
