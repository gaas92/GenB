#Pythia fragment for filtered B0 -> J/psi(mu+mu-)Kshort(pi+pi-) at 13.6TeV
#author: georgios.melachroinos@cern.ch
#TAKEN FROM https://cms-pdmv-prod.web.cern.ch/mcm/requests?prepid=BPH-Run3Summer22GS-00107,BPH-Run3Summer22EEGS-00101&page=0&shown=786559
#ONLY CHANGE IS PHSP FOR SVS
...
ProductionFilterSequence = cms.Sequence(generator*decayfilter*jpsifilter*mufilter*kshortfilter)