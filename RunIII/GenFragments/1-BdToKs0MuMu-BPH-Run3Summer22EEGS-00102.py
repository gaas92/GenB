...
#taken from: https://cms-pdmv-prod.web.cern.ch/mcm/requests?prepid=BPH-Run3Summer22EEGS-00102&page=0&shown=786559
#only change is PHSP instead pf BTOSLLBALL6
...
#
Decay MyB0
1.000  MyK_S0      mu+     mu-    PHOTOS PHSP;
Enddecay
CDecay Myanti-B0
#
Decay MyK_S0
