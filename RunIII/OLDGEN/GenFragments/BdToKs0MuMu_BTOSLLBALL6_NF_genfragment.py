# Script taken from https://cms-pdmv.cern.ch/mcm/public/restapi/requests/get_fragment/BPH-Commission22GS-00001/0
# Filter efficiency = UNKNOWN
# Timing = UNKNOWN sec/event
# Event size = UNKNOWN kB/event
...
'#',
'Decay MyB',
'1.000       MyK0s  mu+ mu-  PHOTOS BTOSLLBALL 6;', # or PHOTOS BTOSLLBALL
'Enddecay',
'CDecay Myanti-B',
'End'
), 
        ...
        processParameters = cms.vstring(
            ...
            "511:m0=5.27963",       ## changing also lambda_b0 mass in pythia in PDG Bd is 5.27966
...
decayfilter = cms.EDFilter("PythiaDauVFilter", ## signal filter
        ...
        MinPt           = cms.untracked.vdouble(-99999, -99999, -99999),
        MaxEta          = cms.untracked.vdouble(99999, 99999, 99999),
        MinEta          = cms.untracked.vdouble(-99999, -99999, -99999), 
)
