...
config.General.requestName = '2018-PrivateMC-Step0'+'-BPH_B0toK0MM'+'-'+st
config.General.transferOutputs = True
config.General.transferLogs = False
config.General.workArea = 'crab_'+'2018-PrivateMC-Step0'+'-BPHB0toKMM'

config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = 'BPH_B0toK0MM_1_cfg.py'
